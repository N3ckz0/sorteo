            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-body row">
                        <div class="col-md-5 text-center d-flex align-items-center justify-content-center my-5">
                            <div class="d-flex flex-column">
                                <img src="<?php echo $data['profile']['imagen']; ?>" alt="foto de perfil" class="img-fluid">
                                <a class="btn btn-info mt-3" href="/admin/changeprofilephoto">Cambiar Imagen</a>
                            </div>
                        </div>
                        <div class="col-md-7">
                            ...
                            <div class="form-group d-flex justify-content-around">
                                <a href="/admin/changeprofile" type="submit" class="btn btn-warning">Modificar Perfil</a>
                                <a href="/admin/changepassword" type="submit" class="btn btn-danger">Cambiar Contraseña</a>
                            </div>
                        </div>
                    </div>
                </div>
