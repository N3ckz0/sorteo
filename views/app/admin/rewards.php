            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <a href="/admin/newreward" class="btn btn-success">Agregar Premio</a>
                        </h3>
                    </div>
                    <div class="card-body">
                                    ...
                                    if($_SESSION['rewards'] != null){
                                      foreach ($_SESSION['rewards'] as $r) {
                                        ...
                                        <td>".$r["descripcionCatego"]."</td>
                                         <td><a class='btn' href='/admin/modifyreward/".$r["id"]."'><i class='fa fa-solid fa-pen' style='color:rgb(255, 193, 7);'></i></a></td>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = '/admin/deletereward/' + rewardId;
                    }
                });
            });
        });
