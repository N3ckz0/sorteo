                    ...
                    <div class='card-body pb-0'>
                        <div class='row'>
                            ...
                            if($_SESSION['pending'] == null){
                                echo "No hay premios pendientes.";
                            }else{
                                foreach ($_SESSION['pending'] as $p) {
                                ...
                                <div class='card bg-light d-flex flex-fill'>
                                    ...
                                    <div class='card-footer'>
                                        <div class='text-right'>
                                            <a href='/admin/authorize/".$p["id"]."' class='btn btn-sm btn-success'>
                                                <i class='bi bi-check-circle'></i> Autorizar Premio
                                            </a>
                                            <a href='/admin/deny/".$p["id"]."' class='btn btn-sm btn-danger'>
                                                <i class='bi bi-x-circle'></i> Denegar Premio
                                            </a>
                                        </div>
                                    </div>
                                </div>
