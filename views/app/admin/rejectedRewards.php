             ...
             <section class="content">
                ...
                <div class='card card-solid'>
                    <div class='card-body pb-0'>
                        <div class='row'>
                            <?php
                            if($_SESSION['rejected'] == null){
                                echo "No hay premios denegados.";
                            }else{
                                foreach ($_SESSION['rejected'] as $p) {
