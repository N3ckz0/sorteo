                ...
                <div class="card">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-sm-12 col-lg-6 col-xl-5 text-center d-flex flex-column align-items-center justify-content-center">
                            ...
                            <a class="btn btn-info my-4" href="/admin/changeimagesreward">Cambiar Imagen <strong>*</strong></a>
                        </div>
                        <div class="col-sm-12 col-lg-6 col-xl-7">
                            <form action="/admin/savereward" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
