            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <a href="/user/newcategory" class="btn btn-success">Agregar Categoría</a>
                        </h3>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($_SESSION['categories'] as $value) {
                                        ...
                                        <td><a href='/user/modifycategory/".$value["id"]."'><i class='fa fa-solid fa-pen' style='color:rgb(255, 193, 7);'></i></a></td>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = '/user/deletecategory/' + categoryId;
                    }
                });
            });
        });
